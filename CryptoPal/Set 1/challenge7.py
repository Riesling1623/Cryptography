"""
    CryptoPals - Set 1
    Challenge 7: AES in ECB mode Solution
"""
...
def sub_bytes(s, sbox=s_box):
    flatten_lst = [item for row in s for item in row]
    res = [sbox[i] for i in flatten_lst]
    return [res[i:i+4] for i in range(0, len(res), 4)]
...
if __name__ == "__main__":
    ...
    with open("./CryptoPal/Set 1/7.txt") as file:
        CONTENT = file.read()
